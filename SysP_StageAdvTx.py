# -*- coding: utf-8 -*-
"""
A program to describe the treatment and recovery process for an incident Advanced Stage oral cancer.
Entities with a diagnosed stage III/IV cancer will be treated either surgically (with/without RT),
...
class StageAdvTx:
    ...
    def Process(self, entity):
        ...
        if nextEvent[0] < 3650:  # Entity experiences some event between 3 months and 10 years
            entity.utility.append(("Advanced Cancer Under Treatment", self._estimates.Util_StageI_Tx.sample(), entity.allTime))
        ...
        if entity.tx_prim == 'Surgery':
            entity.hadSurgery = 1                
            entity.surgery = 1
            entity.resources.append(("Treatment - Advanced - Surgery", entity.allTime))
            entity.events.append(("Treatment - Advanced - Surgery", entity.allTime))
            
        elif entity.tx_prim == 'SurgeryRT':
            entity.hadSurgery = 1
            entity.resources.append(("Treatment - Advanced - Surgery + RT", entity.allTime))
            entity.events.append(("Treatment - Advanced - Surgery", entity.allTime))
            entity.hadRT = 1
            entity.RTCount += 1
            ...
            entity.resources.append(("Treatment - Advanced - Other", entity.allTime))
            entity.events.append(("Treatment - Advanced - Other", entity.allTime))
